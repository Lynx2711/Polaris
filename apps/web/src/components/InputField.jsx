...
export default function InputField({ label, id, type = 'text', error, placeholder, register, icon: Icon, ...rest }) {
  return (
    <div className="space-y-1.5 w-full">
      ...
      >
        {Icon && <Icon className={`h-4 w-4 shrink-0 ${error ? 'text-red-400' : 'text-slate-400'}`} />}
        <input
          id={id}
          type={type}
