...
const ADMIN_ITEMS = [
  ...
  { id: 'organizations', icon: 'domain',            label: 'Organizations' },
  { id: 'users',        icon: 'manage_accounts',   label: 'Users Directory' },
  { id: 'analytics',    icon: 'analytics',         label: 'Analytics' },
  { id: 'health',       icon: 'dns',               label: 'System Health' },
  { id: 'logs',         icon: 'receipt_long',      label: 'Activity Logs' },
  { id: 'settings',     icon: 'settings',          label: 'Console Settings' },
];

export default function PlatformAdminSidebar({ activeTab, onTabChange, isExpanded, setIsExpanded }) {
  const [hovered, setHovered] = useState(null);

  const sidebarW = isExpanded ? 210 : 64;
